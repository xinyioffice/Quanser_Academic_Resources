function Container = QCar2MakeSetTransformContainer(DeviceNumber, Location_v3, Rotation_v3, EnableDynamics, Headlights, LeftTurn, RightTurn, BrakeLight, Honk) %#codegen
